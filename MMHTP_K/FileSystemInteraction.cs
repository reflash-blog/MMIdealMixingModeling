...
using MMLab2.Model;
using MMLab2.View.MessageBox;
using Newtonsoft.Json;

namespace MMLab2.View
{
    /// <summary>
    ...
    public class FileSystemInteraction
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async static Task<InputData> OpenFile()
        {
            InputData inpDObj = null;                                                      // Описываем возвращаемый объект
            ...
            else                                                                           // Если нет, то 
            {
                ...
                if (CustomMessageBox.Show(                                                // Спрашиваем пользователя, действительно ли
                    null,                                                                 // он хочет открыть файл, возможно потеряв
        ...
        /// <param name="filename"></param>
        /// <returns></returns>
        private async static Task<InputData> InputObjectFromFile(string filename)
        {
            ...
            return JsonConvert.DeserializeObject<InputData>(json);                   // Возвращаем строку с данными
